"""ERB proton shielding product construction.

This module intentionally implements only proton transport through aluminium.
Electron transport, bremsstrahlung, dose and single-event-effect calculations
are deferred until their physical models are specified.
"""
